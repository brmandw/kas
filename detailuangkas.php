<?php 
  ...
  if (isset($_POST['btnEditPembayaranUangKas'])) {
    if (editPembayaranUangKas($_POST) > 0) {
      ...
      header("Location: detailuangkas.php?id_bulan_pembayaran=$id_bulan_pembayaran");
    }
  }
...
<!-- End of Sidebar -->
      ...
      <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        <ul class="navbar-nav">
            <li class="nav-item d-none d-sm-inline-block">
              <a href="siswa.php" class="nav-link">Uang Kas</a>
            </li>
          </ul>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm">
            <h1 class="h3 mb-2 text-gray-800">Detail Bulan Pembayaran : <?= ucwords($detail_bulan_pembayaran['nama_bulan']); ?> <?= $detail_bulan_pembayaran['tahun']; ?></h1>
